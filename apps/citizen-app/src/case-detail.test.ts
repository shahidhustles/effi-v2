...
import { caseImages, statusStepState, timelineEntryTitle, type CitizenTimelineEntry } from "./case-detail";
...
describe("citizen case detail", () => {
  ...
  it("keeps only image evidence without inventing missing URLs", () => {
    expect(caseImages([
