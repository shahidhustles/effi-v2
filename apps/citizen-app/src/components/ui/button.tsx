...
import type { SpinnerVariant } from '@/components/ui/spinner';
...
export const Button = forwardRef<View, ButtonProps>(
  (
    ...
    const handlePressIn = (ev: GestureResponderEvent) => {
      ...
      // Scale down on press, the way physical controls depress. Growing past
      // the resting size reads as expansion, not pressure.
